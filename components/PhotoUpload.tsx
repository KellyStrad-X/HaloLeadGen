    ...
    <div className="space-y-6">
      ...
      <div
        ...
        className={`relative border-2 border-dashed rounded-lg p-12 text-center cursor-pointer transition-colors ${
          isDragging
            ...
            : 'border-halo-dark hover:border-halo-medium'
        }`}
      >
        <input
          ref={fileInputRef}
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4">
            {photos.map((photo, index) => (
              <div
                key={photo.id}
                className="relative bg-halo-dark border border-halo-dark rounded-lg overflow-hidden group"
              >
                {/* Order number */}
      ...
      {isUploading && (
        <div className="space-y-2">
          ...
          <div className="w-full h-2 bg-halo-dark rounded-full overflow-hidden">
            <div
