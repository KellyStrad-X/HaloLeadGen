export default function VideoDemo() {
  return (
    <section className="bg-gradient-to-b from-black to-gray-900 text-white py-20 px-4 sm:px-6 lg:px-8">
      <div className="max-w-6xl mx-auto">
        ...
        {/* Video placeholder */}
        <div className="relative bg-gray-900 border-2 border-cyan-400/30 rounded-lg overflow-hidden aspect-video">
          {/* Placeholder content */}
          <div className="absolute inset-0 flex flex-col items-center justify-center p-8">
            ...
            <div className="text-sm text-gray-500 bg-gray-800 px-4 py-2 rounded-full">
        ...
        <div className="grid md:grid-cols-3 gap-6 mt-12">
          <div className="text-center">
            ...
            <p className="text-gray-400 text-sm">Create a campaign in under 5 minutes</p>
          </div>
          <div className="text-center">
            <div className="text-cyan-400 text-3xl mb-2">📱</div>
            <h4 className="font-semibold mb-1">Instant QR Codes</h4>
            <p className="text-gray-400 text-sm">Automatically generated for each campaign</p>
          </div>
          <div className="text-center">
            <div className="text-cyan-400 text-3xl mb-2">📊</div>
            <h4 className="font-semibold mb-1">Track Everything</h4>
            <p className="text-gray-400 text-sm">Monitor leads and engagement in real-time</p>
          </div>
        </div>
        ...
        <div className="mt-8 p-4 bg-gray-800/50 border border-gray-700 rounded-lg">
          <p className="text-xs text-gray-500 text-center">
            <strong className="text-gray-400">To add your video:</strong> Replace the placeholder content above with an iframe embed (YouTube, Loom, Vimeo, etc.)
          </p>
        </div>
      </div>
    </section>
