  ...
  return (
    <section className="bg-slate-900 text-white py-20 px-4 sm:px-6 lg:px-8">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="bg-slate-800/60 border-2 border-cyan-400/40 rounded-lg p-12 mb-12 shadow-xl">
          <div className="max-w-3xl mx-auto">
            ...
            <div className="space-y-3 mb-8">
              <div className="flex items-center gap-4 border-b border-slate-600 pb-3">
                <div className="flex-1 h-4 bg-slate-700 rounded"></div>
                <div className="w-24 h-4 bg-slate-700 rounded"></div>
                <div className="w-16 h-4 bg-cyan-400/40 rounded"></div>
              </div>
              <div className="flex items-center gap-4 border-b border-slate-600 pb-3">
                <div className="flex-1 h-4 bg-slate-700 rounded"></div>
                <div className="w-24 h-4 bg-slate-700 rounded"></div>
        ...
        <div className="grid md:grid-cols-3 gap-6 text-center">
          <div className="p-6">
            ...
            <p className="text-gray-300 text-sm">Your data is protected with industry-standard security</p>
          </div>
          <div className="p-6">
            <div className="text-cyan-400 text-2xl mb-2">📊</div>
            <h4 className="font-semibold mb-2">Your data stays yours</h4>
            <p className="text-gray-300 text-sm">Export your leads anytime, no lock-in</p>
          </div>
          <div className="p-6">
            <div className="text-cyan-400 text-2xl mb-2">✓</div>
            <h4 className="font-semibold mb-2">No long-term contracts</h4>
            <p className="text-gray-300 text-sm">Flexible plans that grow with your business</p>
          </div>
        </div>
      </div>
    </section>
